...
import appleFlag from "../../assets/images/icons/16.png";
  ...
  return (
    <footer className={styles["footer-wrapper"]}>
      <div className={styles.container}>
        ...
        <div className={`row ${styles["footer-links-wrapper"]}`}>
          <div className={`col-sm-12 col-md ${styles["links-wrapper-1"]}`}>
          ...
          <div className={`col-sm-12 col-md ${styles["links-wrapper-2"]}`}>
            <h3>Services</h3>
            <ul>
              <li>
          ...
          <div className={`col-sm-12 col-md ${styles["links-wrapper-3"]}`}>
            <h3>Apple Store</h3>
            <ul>
              <li>
          ...
          <div className={`col-sm-12 col-md ${styles["links-wrapper-4"]}`}>
            <h3>For Business</h3>
            <ul>
              <li>
          ...
          <div className={`col-sm-12 col-md ${styles["links-wrapper-5"]}`}>
            <h3>Apple Values</h3>
            <ul>
              <li>
                <a href="#">Find a Store</a>
        ...
        <div className={`row ${styles["copyright-wrapper"]}`}>
          <div
            className={`col-sm-12 order-2 col-md-8 order-md-1 col-lg-4 order-lg-1 ${styles["copyright"]}`}
          >
            Copyright &copy; 2020 Apple Inc. All rights reserved.
          </div>
          <div
            className={`col-sm-12 order-3 col-lg-6 order-lg-2 ${styles["footer-links-terms"]}`}
          >
            <ul>
              <li>
          ...
          <div
            className={`col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3 ${styles["footer-country"]}`}
          >
            <div className={styles["flag-wrapper"]}>
              <img src={appleFlag} alt="Apple Flag" />
            </div>
